                        ...
                        @if (!is_null($content))
                            <div class="text-center my-5">
                                ...
                                <div class="d-flex justify-content-center fs-2 gap-4">
                                    <a class="text-gradient" href="https://www.instagram.com/itsmeshiyla_?igsh=MTNwZmp4YWlmNW5vdw=="><i class="bi bi-instagram"></i></a>
                                    <a class="text-gradient" href="https://youtube.com/@nursilaodelatambaga?si=LwO2Tq3qmmppUKaL"><i class="bi bi-youtube"></i></a>
                                    <a class="text-gradient" href="https://github.com/Nursilalatambaga"><i class="bi bi-github"></i></a>
                                </div>
                            </div>
                            </div>
                        @else
