...
Route::controller(JobController::class)->prefix('jobs')->group(function () {
    ...
    Route::get('/educations', [EducationController::class, 'index'])->name('educations');
        Route::get('/index', 'EducationController@index')->name('education.index');
        ...
        Route::put('/edit/{id}', 'EducationController@update')->name('education.update');
        Route::delete('/destroy/{id}', 'EducationController@destroy')->name('education.destroy');
});
